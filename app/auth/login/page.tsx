...
const HamsterLoader = () => (
  <div className="hamster-loader">
    ...
    <p className="loading-text">登录中...</p>
  </div>
)
        ...
        <div className="flex bg-white/60 backdrop-blur-lg rounded-[20px] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.1)] max-w-[1000px] w-[95%] max-h-[85vh] relative z-10 animate-[slideUp_0.6s_ease]">
          ...
          <div className="flex-1 bg-gradient-to-br from-[#2B2D42] to-[#3D405B] p-6 md:p-8 lg:p-10 relative flex flex-col justify-center">
            <div className="max-w-[350px] mx-auto relative z-10 w-full">
              ...
              <h1 className="text-center text-2xl font-bold text-white mb-1 tracking-tight">欢迎回来!</h1>
              <p className="text-center text-[13px] text-white/60 mb-6">请登录您的考勤账户</p>
              ...
              <form onSubmit={handleLogin} className="flex flex-col gap-2">
                ...
                <div className="flex justify-between items-center text-xs mt-2 mb-4">
                  <label className="flex items-center cursor-pointer text-white/60 hover:text-white transition-colors select-none">
                    <input type="checkbox" className="mr-2 accent-[#87CEEB]" />
                    记住我30天
                  </label>
                  <Link href="#" className="text-white/60 hover:text-[#87CEEB] transition-colors">
                    忘记密码?
                  </Link>
                </div>
              ...
              <div className="text-center mt-5 pt-4 border-t border-white/10 text-[13px] text-white/60">
                ...
                <Link href="/auth/register" className="text-[#87CEEB] font-semibold hover:text-white transition-colors">
                  立即注册
                </Link>
              </div>
